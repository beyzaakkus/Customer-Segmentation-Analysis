# Customer-Segmentation-Analysis - Müşteri Segmentasyonu Projesi
Customer-Segmentation-Analysis

## Genel Bakış
Bu proje, `MallCustomer.csv` veri setindeki müşteri verilerini kullanarak müşteri segmentasyonu gerçekleştirmeyi amaçlamaktadır. 
